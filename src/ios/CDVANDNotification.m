...
#import "CDVANDNotification.h"

#define DIALOG_TYPE_ALERT @"alert"
#define DIALOG_TYPE_PROMPT @"prompt"
#define DIALOG_TYPE_PROMPT_NUMERIC @"promptNumeric"

static void soundCompletionCallback(SystemSoundID ssid, void* data);

@implementation CDVANDNotification
...
- (void)promptNumeric:(CDVInvokedUrlCommand*)command
{
    ...
    [self showDialogWithMessage:message title:title buttons:buttons defaultText:defaultText callbackId:callbackId dialogType:DIALOG_TYPE_PROMPT_NUMERIC];
}
